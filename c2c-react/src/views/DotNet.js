...
export default class DotNet extends Component {
            ...
            <div class="adds-wrapper">
                ...
                <div class="item-list">
                    <div class="row">
                        ...
                        <div class="col-sm-7 add-desc-box">
                            <div class="add-details">
                                <h5 class="add-title"><a href="ads-details.html">.Net Tester</a></h5>
                                <div class="info">
                                    <span class="add-type">B</span>
                                    <span class="date">
                                        <i class="fas fa-clock"></i>
                ...
                <div class="item-list">
                    <div class="row">
                        ...
                        <div class="col-sm-7 add-desc-box">
                            <div class="add-details">
                                <h5 class="add-title"><a href="ads-details.html">.Net Engeneer </a></h5>
                                <div class="info">
                                    <span class="add-type">B</span>
                                    <span class="date">
                                        <i class="fas fa-clock"></i>
